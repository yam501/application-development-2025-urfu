...
async def seed_initial_data():
    ...
    DATABASE_URL = os.getenv(
        "DATABASE_URL", "postgresql+asyncpg://postgres:123@localhost:5432/lr2_db"
    )
    ...
    async with async_session() as session:
        ...
        addresses_data = [
            {
                "user_id": users[0].id,
                "street": "7 Sunset Boulevard",
                "city": "Sydney",
                "country": "Australia",
            },
            {
                "user_id": users[1].id,
                "street": "45 Canal Street",
                "city": "Amsterdam",
                "country": "Netherlands",
            },
            {
                "user_id": users[2].id,
                "street": "18 Nevsky Prospect",
